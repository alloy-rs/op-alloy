...
mod channel;
pub use channel::{
    random_channel_id, Channel, ChannelError, ChannelId, ChannelOut, ChannelOutError,
    CHANNEL_ID_LENGTH, FJORD_MAX_RLP_BYTES_PER_CHANNEL, MAX_RLP_BYTES_PER_CHANNEL,
};
