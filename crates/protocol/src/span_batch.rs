...
use crate::{traits::BatchValidator, BatchValidity, BlockInfo, L2BlockInfo, SingleBatch};
...
impl SpanBatch {
    ...
    pub async fn check_batch<BV: BatchValidator>(
        &self,
        cfg: &RollupConfig,
        l1_blocks: &[BlockInfo],
    ...
    pub async fn check_batch_prefix<BF: BatchValidator>(
        &self,
        cfg: &RollupConfig,
