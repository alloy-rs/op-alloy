...
impl OptimismNetworkPayloadEnvelope {
    ...
    pub fn decode_v1(data: &[u8]) -> Result<Self, PayloadEnvelopeError> {
        ...
        let payload = ExecutionPayload::from(ExecutionPayloadV1::from_ssz_bytes(block_data)?);
    ...
    pub fn decode_v2(data: &[u8]) -> Result<Self, PayloadEnvelopeError> {
        ...
        let payload = ExecutionPayload::from(ExecutionPayloadV2::from_ssz_bytes(block_data)?);
    ...
    pub fn decode_v3(data: &[u8]) -> Result<Self, PayloadEnvelopeError> {
        ...
        let payload = ExecutionPayload::from(ExecutionPayloadV3::from_ssz_bytes(block_data)?);
